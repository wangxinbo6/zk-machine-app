    ...
    <b-container style="position:relative;padding-top:20px" >
      ...
      <b-table responsive :stickyColumn=true :items="items" :fields="fields" striped class="manageTable" >
        ...
        <template v-slot:cell(操作)="row">
          <b-button size="sm" variant="primary" @click="row.item.toggleDetails" class="mr-3">
            通过
          </b-button>
          <b-button size="sm" variant="danger" @click="row.item.toggleDetails" >
            拒绝
          </b-button>
        </template>
      </b-table>
  ...
  export default {
    data() {
      return {
        ...
        fields: ['姓名', '电话号','密码', '操作'],
        items: [
          { first_name: 'Dickerson',password:'xxxxxx', last_name: '111111111',relo:'xx'
         },
          { first_name: 'Larsen',password:'xxxxxx', last_name: '222222222',relo:'xx'
        },
         
          { first_name: 'Jami',password:'xxxxxx', last_name: '3333323333',relo:'qq' }
        ]
      }
    },
    methods:{
